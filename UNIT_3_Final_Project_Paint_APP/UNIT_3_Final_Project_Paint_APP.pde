...
boolean lazyeggOn1, lazyeggOn2; // true or false
...
void setup() {
  ...
  lazyegg2= loadImage("lazyegg2.png");
  lazyeggOn1 = false;
  lazyeggOn2 = false; 
}
...
void draw() {
  ...
  //second stamp
  tactile(500, 5, 110, 110);
  lazyeggOnOff2();
  rect(500, 5, 110, 110);
  image(lazyegg2, 500, 5, 110, 110);

  // new button
  strokeWeight (2);
  stroke(0);
  fill(255);
  tactileRect(650, 10, 50, 100);
  rect(650, 10, 50, 100);
  fill(black);
  text( "new", 663, 65);
...
void mouseReleased() {
  ...
  // new button
  if (mouseX >650  && mouseX< 700 && mouseY > 10 && mouseY <110) {
    background (white);
  }
  ...
  //load buttom
  if (mouseX>750 && mouseX<800 && mouseY>10 && mouseY<110) {
